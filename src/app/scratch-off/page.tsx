...
export default function ScratchOff() {
  ...
  const [fix, setFixed] = useState("items-center justify-items-center pt-5 pb-1 gap-16 sm:p-5 font-[family-name:var(--font-geist-sans)]")
  ...
  const getMingleMetadata = async () => {
    ...
    if (id == "4355" || id == "5453" || id == "4927" || id == "4288" || id == "4245" || id == "4175"
      ...
      setInpu(true)
      //setFixed("fixed block md:left-1/3 items-center justify-items-center px-5 pt-7 pb-1 gap-16 sm:p-5 font-[family-name:var(--font-geist-sans)]")
        ...
        <div className={fix}>
          ...
          {bg != "" && (
            ...
            <div className={"text-center space-y-5 space-x-2"}>
              ...
              <p className="text-xl text-center text-black my-1 px-4 font-[family-name:var(--font-pressura)]">Scratch to unbottle your Baby Mingle #{id}</p>
              ...
              <p className="text-xl text-center text-black my-3 px-4 font-[family-name:var(--font-pressura)]">Scratch the above card by swiping on it</p>
