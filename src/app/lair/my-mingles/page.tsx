...
export default function MyMinglesPage() {
   ...
   // --- MULTIPLIERS (ACTUALIZADO A LA LÓGICA ADITIVA) ---
   const holdMult = GameMath.getHoldMultiplier(mingles.length);
   const socialMult = GameMath.getSocialMultiplier(friends.length);

   // Suma aditiva segura: 1 + (Bono Hold) + (Bono Social)
   const totalMult = (1 + (holdMult - 1) + (socialMult - 1)).toFixed(2);
