...
export default function RavenNest() {
  ...
  const c1 = async () => {
    ...
    const approvalHash = await writeContractAsync({
      ...
      functionName: "choice",
      args: [gameTokenId, onlyChoice, playingAddress as `0x${string}`, 0]
    })
  ...
  const c2 = async () => {
    ...
    const approvalHash = await writeContractAsync({
      ...
      address: GameAddressAccordingToChain(chainId) as `0x${string}`,
      functionName: "choice",
      args: [gameTokenId, onlyChoice, playingAddress as `0x${string}`, 1]
    })
  ...
  const c3 = async () => {
    ...
    const approvalHash = await writeContractAsync({
      ...
      address: GameAddressAccordingToChain(chainId) as `0x${string}`,
      functionName: "choice",
      args: [gameTokenId, onlyChoice, playingAddress as `0x${string}`, 2]
    })
        ...
        <>
          <div className="flex text-center mt-3">
            <video className="px-5" width="600" height="600" autoPlay loop controls preload="none">
              <source src="/videos/Raven_Nest.mov" />
