...
export default function MainHall() {
  ...
  const choice1 = "oven room"
  const choice2 = "distillery room"
          ...
          <>
            <div className="flex text-center mt-3">
              <video className="px-5" width="600" height="600" autoPlay loop controls preload="none">
                <source src="/videos/Main_Hall.mov" />
            ...
            <p className="mt-8 text-black text-md font-[family-name:var(--font-hogfish)]">{message == "" ? "YOU'VE ENTERED THE MAIN HALL" : "YOU'RE STILL IN THE MAIN HALL"}</p>
