...
export default function OvenRoom() {
        ...
        (
          ...
          <>
            ...
            <div className="text-center">
              ...
              <p className="mt-8 text-black text-md font-[family-name:var(--font-hogfish)]">{message == "" ? "YOU'VE ENTERED THE OVEN ROOM" : "YOU'RE STILL IN THE OVEN ROOM"}</p>
